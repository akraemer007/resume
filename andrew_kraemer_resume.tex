    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Science Frontier Team}
          \resumeDetailStart
            \resumeDetail{Developed Cerebri's recommender system framework from initial experimentation to implementaion}
            \resumeDetail{Archetechted internal cross-package autoML tool to increase model experimentation rate}
          \resumeDetailEnd
        ...
        \resumeItem{Data Science - Core Team (Automotive Vertical)}
          ...
          \resumeDetailStart
            \resumeDetail{Injested, analyzed, and re-engineered client data to conform to Cerebri data standards}
        ...
        \resumeItem{Data Science Standards Lead}
         %  {Lead multi-channel team to research, disucss, and implement standards on the Data Science team. Standards include: custom packages for consistent data aquisition and cleaning, coding style standards, git workflow, and documentation guidelines}
          \resumeDetailStart
            \resumeDetail{Created and lead internal team to research, disucss, and implement standards for the Data Science team}
            \resumeDetail{Set standards for: git-workflow, code standards, utility plotting package, and documentaion best practices}
          \resumeDetailEnd
      \resumeItemListEnd
